...
I will mainly be using the Python programming language, along with other tools to increase my skills in using Python to read and manipulate network devices. This will include Python modules such as Jinja2 and Netmiko, and automation tools such as Ansible.
